...
> Design notes for **edtech-course-receipt-service** — a runnable python example that Typed Python service for course receipts, learner deadlines, and educator reporting.
...
- **Feature code** — the actual task: course-receipt-email.
